...
//		console.log("trying to remove cell " + vals);
		...
		if (!solve(newGrid))
		{
//			console.log("0 - adding back cell " + vals);
			newGrid[vals[0]][vals[1]] = old;
		}
	}
	
//	for (var i = queue.length - 1; i >= 0 && !solve(newGrid); i--)
//	{
//		vals = queue[i];
//		if (!solve(newGrid))
//		{
//			console.log("1 - adding back cell " + vals);
